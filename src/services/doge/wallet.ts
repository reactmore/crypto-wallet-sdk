...
import { DogeWallet as DogeWalletOkx } from "@okxweb3/coin-bitcoin";
import { IResponse, GenerateWalletPayload } from "./../../types";

const successResponse = (args: IResponse): IResponse => args;

export class DogeWallet extends BaseWallet {

    private wallet: DogeWalletOkx;

    constructor(config: DexConfig) {
        super(config);
        this.wallet = new DogeWalletOkx();
    }
